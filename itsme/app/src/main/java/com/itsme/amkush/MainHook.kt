package com.itsme.amkush
  ...
  class MainHook : IXposedHookLoadPackage {
      ...
      override fun handleLoadPackage(lpparam: XC_LoadPackage.LoadPackageParam) {
          ...
          // ==================== CAMERA HOOKS (GStreamer architecture) ====================
          ...
          // Actual stream decoding and frame writing happen in InjectionService (module process).
      ...
      //      (InjectionService + GStreamerPipeline).  The camera hooks will
              ...
              XposedHelpers.findAndHookMethod(
                  ...
                  object : XC_MethodHook() {
                      override fun afterHookedMethod(param: MethodHookParam) {
                          ...
                          Logger.d("Target app detected: ${lpparam.packageName} — GStreamer camera block active")
                          ...
                          // NOTE: DecoderLauncher.ensureLaunched() is intentionally NOT called here.
                          // The GStreamer pipeline runs in the MODULE PROCESS (InjectionService).
                          // GStreamerSurfaceRouter connects to InjectionService via Binder the first
